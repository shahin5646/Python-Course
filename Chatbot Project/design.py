...
def main(page: ft.Page):
    ...
    def send_message_click(e):
        if new_message.value != "":
            ...
            page.pubsub.send_all(Message(user_name="Mr. Robot", text="Mr. Robot is getting the response for you...", message_type="login_message"))
            ai_response = chatbot_response(str(new_message.value), knowledge_base, "knowledge_base.json")
            page.pubsub.send_all(Message("Mr. Robot", str(ai_response).lstrip(), message_type="chat_message"))
            new_message.value = ""
            new_message.focus()
            page.update()
    ...
    page.add(
        ft.Row([ft.Text("Mr.Robot ChatBot", font_family="comic", style="headlineLarge", color="blue")], alignment="center"),
        ft.Container(
            content=chat,
